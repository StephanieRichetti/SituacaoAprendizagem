...
public class EmailUtil {
	...
	String assunto, String conteudo) throws AddressException,
	...
	MessagingException {
		...
		InternetAddress destinatarioEmail = new
		...
		(Message.RecipientType.TO, destinatarioEmail);
	...
	private static Authenticator getAuthenticator() {
		...
		return new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				PasswordAuthentication(context.getInitParameter("usuario"),
	...
	private static Properties getProperties() {
		...
		context.getInitParameter("servidor"));
		properties.put("mail.smtp.port",

		context.getInitParameter("porta"));
		properties.put("mail.smtp.auth",

		context.getInitParameter("auth"));
